...
class VariableCreationDTO {
  ...
  @override
  String toString() {
    return 'VariableCreationDTO[uri=$uri, name=$name, alternativeName=$alternativeName, description=$description, entity=$entity, entityOfInterest=$entityOfInterest, characteristic=$characteristic, trait=$trait, traitName=$traitName, method=$method, unit=$unit, species=$species, datatype=$datatype, timeInterval=$timeInterval, samplingInterval=$samplingInterval, exactMatch=$exactMatch, closeMatch=$closeMatch, broadMatch=$broadMatch, narrowMatch=$narrowMatch, ]';
  }
