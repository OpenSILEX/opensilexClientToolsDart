...
class VariableUpdateDTO {
  ...
  static List<VariableUpdateDTO> listFromJson(List<dynamic> json) {
    return json == null ? new List<VariableUpdateDTO>() : json.map((value) => new VariableUpdateDTO.fromJson(value)).toList();
  }

  static Map<String, VariableUpdateDTO> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, VariableUpdateDTO>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new VariableUpdateDTO.fromJson(value));
    }
    return map;
  }
}
