...
class ObjectUriResponse {
  ...
  static List<ObjectUriResponse> listFromJson(List<dynamic> json) {
    return json == null
        ? new List<ObjectUriResponse>()
        : json.map((value) => new ObjectUriResponse.fromJson(value)).toList();
  }

  static Map<String, ObjectUriResponse> mapFromJson(
      Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, ObjectUriResponse>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) =>
          map[key] = new ObjectUriResponse.fromJson(value));
    }
    return map;
  }
}
