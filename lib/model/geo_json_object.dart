...
class GeoJsonObject {
  ...
  static List<GeoJsonObject> listFromJson(List<dynamic> json) {
    return json == null ? new List<GeoJsonObject>() : json.map((value) => new GeoJsonObject.fromJson(value)).toList();
  }

  static Map<String, GeoJsonObject> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, GeoJsonObject>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new GeoJsonObject.fromJson(value));
    }
    return map;
  }
