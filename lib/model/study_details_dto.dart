...
;
    ...
    ;
    contacts =
      Contact.listFromJson((json['contacts'] as List).map((e) => e as Map<String, dynamic>).toList())
;
    datalinks =
      DataLink.listFromJson((json['datalinks'] as List).map((e) => e as Map<String, dynamic>).toList())
;
    location =
