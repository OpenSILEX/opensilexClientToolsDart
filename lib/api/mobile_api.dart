...
headerParams["Accept-Language"] = acceptLanguage;
  ...
  Future<ObjectUriResponse> deleteForm(String uri,  { String acceptLanguage }) async {
    ...
    // create path and map variables
    String path = "/mobile/{uri}".replaceAll("{format}","json").replaceAll("{" + "uri" + "}", uri.toString());
...
headerParams["Accept-Language"] = acceptLanguage;
  ...
  ///
  /// 
  Future<List<FormGetDTO>> searchFormList( { List<String> uris, List<String> orderBy, int page, int pageSize, String acceptLanguage }) async {
    Object postBody = null;
...
headerParams["Accept-Language"] = acceptLanguage;
  ...
  ///
  /// 
  Future<ObjectUriResponse> update1( { FormUpdateDTO body, String acceptLanguage }) async {
    Object postBody = body;
