...
[**searchFormList**](MobileApi.md#searchFormList) | **GET** /mobile/section_get | Search sections
...
# **searchFormList**
> List<SectionGetDTO> searchFormList(authorization, uris, orderBy, page, pageSize, acceptLanguage)
