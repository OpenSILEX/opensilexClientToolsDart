...
------------- | ------------- | -------------
[**createForm**](MobileApi.md#createForm) | **POST** /mobile/forms | Add a form
[**deleteForm**](MobileApi.md#deleteForm) | **DELETE** /mobile/{uri} | Delete form
[**searchFormList**](MobileApi.md#searchFormList) | **GET** /mobile | Search forms
...
var api_instance = new MobileApi();
var uri = uri_example; // String | Form URI
var authorization = authorization_example; // String | Authentication token
var acceptLanguage = en; // String | Request accepted language
...
# **searchFormList**
> List<FormGetDTO> searchFormList(authorization, uris, orderBy, page, pageSize, acceptLanguage)
...
try { 
    var result = api_instance.searchFormList(authorization, uris, orderBy, page, pageSize, acceptLanguage);
    print(result);
} catch (e) {
    print("Exception when calling MobileApi->searchFormList: $e\n");
}
```
...
try { 
    ...
    print("Exception when calling MobileApi->update1: $e\n");
}
```
